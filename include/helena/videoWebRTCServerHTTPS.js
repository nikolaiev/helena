...
var pg=require('pg');
var fs=require('fs');
var io;//в будущем - сервер сокетов
...
module.exports=function(app){
	...
	server.listen(PORT,function(){
		console.log('videoWebRTCServer server listening at '+PORT);	
	});
    ...
    io.sockets.on('connection', function(socket) {
        ...
        try {
            ...
            if(typeof user_id =='undefined'){
                user_id='admin_'+Math.ceil(Math.random()*100);

            }
        }
        console.log('user connected to webRTC');
        console.log(user_id);
